...
public class ChatChannel {
    ...
    public void fchat(Player player, String message) {
            ...
            String senderFaction = myStringTokenizer.nextElement().toString(); //obtains player's faction name
            ...
            if (senderFaction.equalsIgnoreCase("~")) { //checks if player is in a faction
                ...
                for (int i = 0; i < onlinePlayerList.length; i++) {
                    ...
                    myStringTokenizer = new StringTokenizer(P.p.getPlayerFactionTag(onlinePlayerList[i]), "*[] ");
                    playersFaction = myStringTokenizer.nextElement().toString();
    ...
    public void fchata(Player player, String message) {
            ...
            StringTokenizer myStringTokenizer = new StringTokenizer(P.p.getPlayerFactionTag(player), "*[] "); // gets raw infomation of faction tag
            String sSenderFaction = myStringTokenizer.nextElement().toString(); //obtains player's faction name
            ...
            if (sSenderFaction.equalsIgnoreCase("~")) { //checks if player is in a faction
               ...
               // fSenderPlayer.sendMessage(message);
                for (Player myplayer : onlinePlayerList)
                {
                    ...
                    myStringTokenizer = new StringTokenizer(P.p.getPlayerFactionTag(myplayer), "*[] ");
                    sPlayersFaction = myStringTokenizer.nextElement().toString();
    ...
    public void jrModChat(Player player, String message)
    {
        ...
        for (Player myplayer : onlinePlayerList)
        {
            if (myplayer.hasPermission("FactionChat.JrModChat"))
            {
    ...
    public void modChat(Player player, String message)
    {
        ...
        for (Player myplayer : onlinePlayerList)
        {
            if (myplayer.hasPermission("FactionChat.ModChat"))
            {
    ...
    public void SrModChat(Player player, String message)
    {
        ...
        for (Player myplayer : onlinePlayerList)
        {
            if (myplayer.hasPermission("FactionChat.SrModChat"))
            {
    ...
    public void JrAdminChat(Player player, String message)
    {
        ...
        for (Player myplayer : onlinePlayerList)
        {
            if (myplayer.hasPermission("FactionChat.JrAdminChat"))
            {
    ...
    public void adminChat(Player player, String message)
    {
        ...
        for (Player myplayer : onlinePlayerList)
        {
            if (myplayer.hasPermission("FactionChat.AdminChat"))
            {
